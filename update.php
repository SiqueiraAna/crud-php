...
if(isset($_POST['submit'])){
    ...
    // $sql="update `pessoas` set id_pessoa = 'id_pessoa', nome = 'nome', endereco = 'endereco', 
...
<html lang="en">
  <head>
    ...
    <title>Update Cadastro</title><br>
  ...
  <div style="text-align:center; font-size: 2.1em; color: #000000;">Atualize seu cadastro!</div>
   ...
   <br>
    ...
    <br>
  <button type="submit" name="submit" class="btn btn-success" onclick="funcao1()">Update</button>
</form>
    </div>
