    ...
    <html lang="en">
      ...
      <body> 
        ...
        type="text" class="form-control" placeholder="Nome Completo" name="nome" value="<?php echo($rows[0]["nome"])?>">
        </div>
        <br>
        ...
        type="text" class="form-control" placeholder="Endereço" name="endereco" value="<?php echo($rows[0]["endereco"])?>">
        </div>
        <br>
        ...
        type="number" class="form-control" placeholder="Telefone" name="telefone" value="<?php echo($rows[0]["telefone"])?>">
        </div>
        <br>
        ...
        type="email" class="form-control" placeholder="Email" name="email" value="<?php echo($rows[0]["email"])?>">
        </div>
        <br>

        <div class="form-group">
        <label>Data Nascimento:</label>
        <input required type="date" class="form-control" placeholder="Data Nascimento" name="data_nascimento" value="<?php echo($rows[0]["data_nascimento"])?>">
        </div>
        <br>
